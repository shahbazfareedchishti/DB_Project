              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      Indulge your taste buds with our mouthwatering burgers at "HungryHub"! 
                      Our juicy, flame-grilled patties are a symphony of flavors, paired with fresh, 
                      crisp veggies and a medley of signature sauces that will leave you craving more.
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      Embark on a pasta paradise at "HungryHub" where every twirl of our 
                       creations is a journey into culinary delight. Our exquisite sauces, made from time-honored recipes, embrace the pasta,
                       creating a symphony of flavors that dance on your palate.
                    </p>
                    <div class="btn-box">
                      <a href="menu.php" class="btn1">
                        Order Now
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      Wrap yourself in flavor at "HungryHub" where our artisanal wraps redefine handheld satisfaction.
                       Fresh, vibrant ingredients come together in a delicious dance of textures,
                       delivering a taste sensation that's both wholesome and indulgent. 
                    </p>
                    <div class="btn-box">
                      <a href="menu.php" class="btn1">
                        Order Now
      ...
      <div class="container ">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/f4.png" alt="" style="margin-top: 35%;">
              </div>
              <div class="detail-box">
                <h5>
                  Pasta Days
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              ...
              creating a delightful dining experience. Feane's golden,
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                   "HungryHub culinary magic never fails to impress! The pasta dishes are a true taste of Italy,
                   and the burgers are nothing short of divine.
                   A perfect blend of quality and innovation. Feane is my go-to for an exceptional dining experience."⭐⭐⭐⭐⭐
                </p>
                <h6>
                  Moana Michell
                </h6>
          ...
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                   "HungryHub delivers burger perfection! Juicy, flavorful patties paired with fresh ingredients create a symphony of taste. 
                  The attention to detail and quality make it a standout burger destination. 
                  I can't get enough of their delicious offerings!"⭐⭐⭐⭐⭐
                </p>
                <h6>
                  Mike Hamell
                </h6>
