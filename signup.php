    ...
    <div class="signin-container">
        <div class="signinnnn">
            ...
            <form method="post" action="process1.php" >
                ...
                <!-- Add name attributes to the rest of your input fields -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" name="Pasword">
                </div>
                <div class="buttons">
                    <div class="signup"><button type="submit" class="btn btn-secondary" name="signup2">Signup</button></div>
                </div>
            </form>
